...
from ev_mdt.models.common.model_utils import consumption, price_bin_probs
from ev_mdt.params import NegBinParams, N_e as _N_E, T_hours as _T_HOURS
from ev_mdt.models.negbin.model import is_driving, transition_matrix
