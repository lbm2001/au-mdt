"""Shared trip-duration comparison across the three mobility models.

Used by the Policy Rollout page and the Sensitivity figure-ZIP builder so the
chart and its underlying sampling stay identical in both places.
"""
import math
...
MOBILITY_COLORS = {"Baseline": "#4477AA", "NegBin (fixed k=5)": "#EE6677",
